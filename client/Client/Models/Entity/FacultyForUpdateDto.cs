...
{
    public class FacultyForUpdateModel: IModel
    {
    ...
    public class FacultyForUpdateModelValidator : AbstractValidator<FacultyForUpdateModel>
    {
        public FacultyForUpdateModelValidator()
        {
